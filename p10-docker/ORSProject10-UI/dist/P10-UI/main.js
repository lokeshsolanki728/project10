...
var EndpointServiceService = /** @class */ (function () {
    function EndpointServiceService() {
        ...
        this.ASSETTRACKING = this.SERVER_URL + "/AssetTracking";
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.isLogin = function () {
        ...
        if (check != "null" && check != null) {
            ...
            // console.log('fname is P---->>>' + this.form.data.fname);
            return true;
        }
        else {
            return false;
...
module.exports = __webpack_require__(/*! C:\Users\lokesh solanki\Desktop\p10fctl\ORSProj10_FrontCtl\ORSProject10-UI Fctl\src\main.ts */"./src/main.ts");
