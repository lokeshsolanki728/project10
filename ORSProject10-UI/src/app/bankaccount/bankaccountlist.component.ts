...
@Component({
  ...
  styleUrls: ['./bankaccountlist.component.css']
})
export class BankaccountlistComponent extends  BaseListCtl implements OnInit {
  public form = {
    error: false,
    message: null,
    preload: {
      branchIdList: [] // Initialize vehicle list
    },
    data: { id: null },
   // inputerror: { quantity: '', productName: '' },
    searchParams: {
      ...
      branchId: null, // Initialize vehicleId to null
      accountNo: '',
  ...
  constructor(public locator: ServiceLocatorService, public route: ActivatedRoute, private httpClient: HttpClient) {
    super(locator.endpoints.BANKACCOUNT, locator, route);
  }
