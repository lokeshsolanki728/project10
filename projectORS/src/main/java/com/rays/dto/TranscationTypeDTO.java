...
@Entity
@Table(name = "ST_TranscationType")
public class TranscationTypeDTO extends BaseDTO {
	...
	@Column(name = "TranscationType_NAME", length = 50)
	private String TranscationTypeName = null;
	...
	public void setTranscationTypeName(String TranscationTypeName) {
		this.TranscationTypeName = TranscationTypeName;
	}
